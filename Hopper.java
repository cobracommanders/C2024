...
public class Hopper extends SubsystemBase {
    ...
    public Hopper() {
        lMotor = new LazySparkMax(Ports.Intake.Hopper, MotorType.kBrushless);
        rMotor = new LazySparkMax(Ports.Intake.Hopper, MotorType.kBrushless);
        ...
        pController = new PController(HopperConstants.P);
        feedforward = new SimpleMotorFeedforward(HopperConstants.S, HopperConstants.V, HopperConstants.A);
    ...
    public void periodic() {
        ...
        set(speed / HopperConstants.MAX_RPM); // set the motor behavior using set() to interact with the controllers
