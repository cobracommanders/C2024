...
public class Flywheel extends SubsystemBase {
    ...
    public Flywheel() {
        lMotor = new LazySparkMax(Ports.Hopper.L_MOTOR, MotorType.kBrushless);
        rMotor = new LazySparkMax(Ports.Hopper.R_MOTOR, MotorType.kBrushless);
    ...
    public void setState(Intake.Flywheel state) {
