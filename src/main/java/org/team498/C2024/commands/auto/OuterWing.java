...
import org.team498.C2024.commands.robot.AutoCancel;
        ...
        return new SequentialCommandGroup(
            ...
            new ParallelDeadlineGroup(
                ...
                new SequentialCommandGroup(
                    new WaitCommand(1.5),
                    new LoadGround().withTimeout(1.7),//2
            ...
            new ParallelDeadlineGroup(
                new PathPlannerFollower(PathLib.outer_wing_3).andThen(new WaitCommand(0.6)), //1
                new SequentialCommandGroup(
                    new SlowScore(2.5),
                    new AutoCancel(),
                    new SlowDrive(DrivetrainConstants.AUTO_SPEED_SCALAR),
