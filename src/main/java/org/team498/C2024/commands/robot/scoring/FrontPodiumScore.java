...
public class FrontPodiumScore extends SequentialCommandGroup{
    public FrontPodiumScore(){
        super(
            new SetState(State.FRONT_PODIUM),
            new InstantCommand(()-> StateController.getInstance().setNextScoringOption(ScoringOption.FRONT_PODIUM)),
