...
public class RobotContainer {
  ...
  private void newControlStyle() {
    ...
    drivetrain.setDefaultCommand(repeatingSequence( // Drivetrain will execute this command periodically
        vision.alignToTag()));//drivetrain.applyRequest(controlStyle).ignoringDisable(true));
  }
